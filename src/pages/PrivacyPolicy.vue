...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      'Advertising Data: When an ad is displayed to you, we record your IP address, user agent, and user ID for impression tracking. This is used solely for campaign analytics and is not used to personalise the ads you see.',
  ...
  },
  {
    ...
    items: [
      ...
      'Display advertisements to authenticated users — ads are contextual and are not personalised based on your profile or behaviour',
      'Record ad impressions and clicks (including IP address, user agent, and user ID) for campaign analytics delivered to advertisers',
    ],
  },
  {
    ...
    items: [
      ...
      'Advertisers: When you view or click an ad, we record your IP address, user agent, and user ID solely for the purpose of generating impression and click analytics. This data is aggregated and reported to advertisers as campaign performance metrics. No personally identifiable information such as your name, email, or profile details is shared with advertisers.',
